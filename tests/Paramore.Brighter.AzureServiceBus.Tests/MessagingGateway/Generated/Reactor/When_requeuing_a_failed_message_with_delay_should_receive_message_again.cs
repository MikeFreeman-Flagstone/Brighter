...
public class WhenRequeuingAFailedMessageWithDelayShouldReceiveMessageAgain : IDisposable
{
    ...
    [Fact]
    public void When_requeuing_a_failed_message_with_delay_should_receive_message_again()
    {
        // Arrange
