...
public interface IAmAMessageGatewayReactorProvider
{
    ...
    IAmAMessageProducerSync CreateProducer(Paramore.Brighter.MessagingGateway.AzureServiceBus.AzureServiceBusPublication publication);
    ...
    IAmAChannelSync CreateChannel(Paramore.Brighter.MessagingGateway.AzureServiceBus.AzureServiceBusSubscription subscription);
    ...
    Message GetMessageFromDeadLetterQueue(Paramore.Brighter.MessagingGateway.AzureServiceBus.AzureServiceBusSubscription subscription);
}
