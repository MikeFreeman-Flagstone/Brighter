...
public class RequestContextPresentTests
{
    ...
    [Test]
    public async Task When_A_Request_Context_Is_Provided_On_A_Send()
    {
        //arrange
    ...
    [Test]
    public async Task When_A_Request_Context_Is_Provided_On_A_Publish()
    {
        //arrange
        var registry = new SubscriberRegistry();
    ...
    [Test]
    public async Task When_A_Request_Context_Is_Provided_On_A_Deposit()
    {
        //arrange
    ...
    [Test]
    public async Task When_A_Request_Context_Is_Provided_On_A_Clear()
    {
        //arrange
        var messageMapperRegistry = new MessageMapperRegistry(new SimpleMessageMapperFactory((_) => new MyCommandMessageMapper()), null);
        messageMapperRegistry.Register<MyCommand, MyCommandMessageMapper>();
