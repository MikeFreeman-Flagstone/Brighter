...
{
    [Test]
    public async Task When_I_serialise_a_vanilla_payload_as_a_utf8_string()
    {
        //arrange
    ...
    [Test]
    public async Task When_I_serialise_a_vanilla_payload_as_a_base64_string()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_serialise_a_raw_payload_as_binary()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_serialise_a_raw_payload_as_a_base64_string()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_try_to_serialise_a_raw_payload_as_a_string()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_serialise_a_kafka_payload_as_binary()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_serialise_a_utf8_kafka_payload_as_bytes()
    {
        //arrange
        var request = new MyTransformableCommand
        {
    ...
    [Test]
    public async Task When_I_try_to_serialise_a_utf8_kafka_payload_as_a_utf8_string()
    {
        //arrange
        var request = new MyTransformableCommand
        {
