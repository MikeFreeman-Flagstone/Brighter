...
namespace Paramore.Brighter.Core.Tests.MessageDispatch.Reactor
{
    public class MessagePumpCommandProcessingExceptionTests
    {
        ...
        public MessagePumpCommandProcessingExceptionTests()
        {
            ...
            _messagePump = new ServiceActivator.Reactor(commandProcessor, (message) => typeof(MyCommand), messageMapperRegistry, new EmptyMessageTransformerFactory(), new InMemoryRequestContextFactory(), _channel)
            {
                Channel = _channel,
