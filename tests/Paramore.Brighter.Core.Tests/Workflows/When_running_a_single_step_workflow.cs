...
public class MediatorOneStepFlowTests
{
    ...
    public MediatorOneStepFlowTests()
    {
        ...
        var firstStep = new Sequential<WorkflowTestData>("Test of Job", new FireAndForgetAsync<MyCommand, WorkflowTestData>((data) => new MyCommand { Value = (workflowData.Bag["MyValue"] as string)! }), () =>
        {
            _stepCompleted = true;
        }, null);
